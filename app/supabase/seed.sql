...
-- =============================================================================
-- Replace the placeholder user_id below with your actual Supabase auth user ID
-- before running this file. You can find your user ID in:
--   Supabase Dashboard -> Authentication -> Users -> your user row -> User UID
--
-- Replace ALL occurrences of: 00000000-0000-0000-0000-000000000000
-- =============================================================================
...
-- ---------------------------------------------------------------------------
-- Portfolio Snapshot (current month baseline)
-- ---------------------------------------------------------------------------
...
insert into goals (user_id, title, description, target_value, current_value, unit, deadline, status) values
  ...
  (
    ...
    'Grow total gross monthly income from the current $12,500 to $25,000 through a combination of career advancement, freelance expansion, and passive investment income. Target is gross income before taxes.',
    25000.00,
    12500.00,
    'USD/month',
    '2028-12-31',
  ...
  (
    ...
    'Grow total invested assets (brokerage + retirement accounts) to $500,000 through consistent contributions and compounding. Does not include primary residence equity.',
    500000.00,
    183200.00,
    'USD',
    '2032-01-01',
